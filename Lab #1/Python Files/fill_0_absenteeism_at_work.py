...
try:
    ...
    df = pd.read_csv('/Users/georgejrodriguez/Downloads/IS170 Lab #1/absenteeism+at+work/Absenteeism_at_work.csv')
...
output_path = 'fill_0_cleaned_absenteeism_data.csv'
